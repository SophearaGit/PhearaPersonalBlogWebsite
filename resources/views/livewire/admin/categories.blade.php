<div>
    <div class="row">
        <div class="col-12">
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <div class="h4 text-blue">Parent categories</div>
                    </div>
                    <div class="pull-right">
                        <a wire:click="addParentCategory()" href="javascript:;"
                            class="btn btn-primary btn-sm float-right">Add P .category</a>
                    </div>
                </div>
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">N. of categories</th>
                        ...
                        <tbody id="sortable_parent_categories">
                            @forelse ($pcategories as $item)
                                <tr data-index="{{ $item->id }}" data-ordering="{{ $item->ordering }}">
                                    ...
                                    <td scope="row">{{ $item->children->count() }}</td>
                                    <td>
                                        <div class="table-actions">
                                            <a href="javascript:;"
                                                wire:click="editParentCategory({{ $item->id }})"><i
                                                    class="dw dw-edit2"></i> </a>
                                            <a href="javascript:;"
                                                wire:click="deleteParentCategory({{ $item->id }})"><i
                            ...
                            @empty
                                <tr>
                                    <td colspan="4"><span class="text-danger">No item found!</span></td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        <div class="col-12">
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    ...
                    <div class="pull-right">
                        <a href="javascript:;" wire:click="addCategory()" class="btn btn-primary btn-sm float-right">Add
                            P .category</a>
                    </div>
                </div>
                <div class="table-responsive mt-4">
                        ...
                        <tbody id="sortable_categories">
                            @forelse ($categories as $item)
                                <tr data-index="{{ $item->id }}" data-ordering="{{ $item->ordering }}">
                                    ...
                                    <td scope="row">{{ count($item->posts) }}</td>
                                    <td>
                                        <div class="table-actions">
                                            <a href="javascript:;" wire:click="editCategory({{ $item->id }})"><i
                                                    class="dw dw-edit2"></i> </a>
                                            <a href="javascript:;" wire:click="deleteCategory({{ $item->id }})"><i
                                                    class="dw dw-delete-3"></i> </a>
                                        </div>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="5" style="text-align: center;"><span class="text-danger">No item
                                            found!</span></td>
                                </tr>
                            @endforelse
                        </tbody>
    ...
    <div wire:ignore.self class="modal fade" id="pcategory_modal" tabindex="-1" role="dialog"
        aria-labelledby="myLargeModalLabel" data-backdrop="" data-keyboard="false" inert>
