<div>
    <div>
        <div class="pd-20 card-box mb-30">
            <div class="row mb-20 d-flex justify-content-between align-items-center">
                <div class="col-md-4">
                ...
                @if (auth()->user()->type == 'super_admin')
                    <div class="col-md-2">
                        ...
                        <select wire:model.live="author" id="author" class="custom-select form-control">
                            ...
                            @foreach (APP\Models\User::whereHas('portfolios')->get() as $user)
                    ...
                    <tbody>
                        @forelse ($portfolios as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="">
                                        <img src="/images/portfolios/resized/resized_{{ $item->featured_image }}"
                                            width="100" alt="">
                                    </a>
                                </td>
                                <td>{{ $item->title }}</td>
                                ...
                                <td>
                                    <div class="table-actions">
                                        <a href="{{ route('admin.edit_portfolio', ['id' => $item->id]) }}"
                                            data-color="#2653ed7" style="color:rgb(39,94,215)">
                                            <i class="icon-copy dw dw-edit2"></i>
                                        </a>
                                        <a href="javascript:;" wire:click="deletePortfolio({{ $item->id }})"
            ...
            <div class="block mt-1">
                <div class="">
                    {{ $portfolios->links('livewire::simple-bootstrap') }}
                </div>
            </div>
        </div>
    </div>
