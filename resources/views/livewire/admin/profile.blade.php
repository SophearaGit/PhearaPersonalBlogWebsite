            ...
            <div class="pd-20 card-box height-100-p">
                ...
                <div id="croppie-modal" class="modal" style="display: none">
                    <div class="modal-content">
                        ...
                        <div id="upload-demo"></div> <!-- Croppie area -->
                    ...
                    <div class="tab height-100-p">
                        ...
                        <div class="tab-content">
                                    ...
                                    <form wire:submit="updatePersonalDetails()">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" wire:model="email"
                                                        placeholder="Enter email here." disabled>
                                                    @error('email')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="">Bio</label>
                                                    <textarea wire:model="bio" cols="4" row="10" class="form-control" placeholder="Type bio here."></textarea>
                                                    @error('email')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                            ...
                            <div class="tab-pane fade {{ $tab == 'social_links' ? 'show active' : '' }} "
                                ...
                                <div class="pd-20 profile-task-wrap">
                                    <form action="post" wire:submit="updateSocialLinks()">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
