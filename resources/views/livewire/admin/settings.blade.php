    ...
    <div class="tab">
        <ul class="nav nav-tabs customtab" role="tablist">
            <li class="nav-item">
                <a wire:click="selectTab('general_settings')"
                    ...
                    href="#general_settings" role="tab" aria-selected="true">Home</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content">
            <div class="tab-pane fade {{ $tab == 'general_settings' ? 'active show' : '' }} " id="general_settings"
                role="tabpanel">
                <div class="pd-20">
                    <form action="" wire:submit="updateSiteInfo()">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for=""><b>Site Title</b></label>
                                    <input type="text" class="form-control" id="site_title" name="site_title"
                                        wire:model="site_title" placeholder="Enter site title here.">
                                    @error('site_title')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="site_email" name="site_email"
                                        wire:model="site_email" placeholder="Enter site email here.">
                                    @error('site_email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="site_phone" name="site_phone"
                                        wire:model="site_phone" placeholder="Enter site phone here.">
                                    @error('site_phone')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="site_meta_keywords"
                                        name="site_meta_keywords" wire:model="site_meta_keywords"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for=""><b>Site Meta
                                            Description</b>&nbsp;<small>(Optional)</small></label>
