...
@section('content')
    <main>
        ...
        <section class="cs_100_bg position-relative" data-src="/front/assets/img/bg/ed_and_skill_bg.png">
            <div class="cs_slill_shape_1 position-absolute">
                <img src="/front/assets/img/skills_shape_1.svg" alt="skill and education ">
            </div>
                        ...
                        <div class="cs_education_wrap">
                            ...
                            <div class="cs_iconbox cs_style_3 cs_type_1 d-flex align-items-center">
                                <div class="cs_iconbox_icon cs_accent_color cs_filled_bg cs_center"
                                    data-src="/front/assets/img/bg/iconbox_bg_3.svg">
        ...
        <section class="position-relative">
            <div class="cs_service_shape_1 position-absolute">
                <img src="/front/assets/img/service_shape_1.svg" alt="">
            </div>
            <div class="cs_height_150 cs_height_lg_80"></div>
            <div class="container">
                <div class="row cs_tabs cs_style_1">
                    <div class="col-lg-4">
                        <div class="cs_section_heading cs_style_1">
                            ...
                            <h2 class="cs_section_title cs_font_48 cs_semi_bold">Moments<br> of <span
                                    class="cs_accent_color">my
                                    life</span>
                            </h2>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="cs_tab_body">
                                <div class="cs_tab active" data-id="travel">
                                    <p class="m-0">Lorem ipsum dolor sit amet, <span
                                            class="cs_accent_color">consectetuer
                                            adipiscing
                                            elit</span>. Cum sociis natoque penatibus et magnis dis parturient montes,<span
                                            class="cs_accent_color"> nascetur ridiculus</span> mus. Donec quam felis,
                                        ultricies
                                        nec, <span class="cs_accent_color_2">pellentesque eu</span>, pretium quis, sem.
                                        Nulla
                                ...
                                <div class="cs_tab" data-id="creativity">
                                    <p class="m-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa
                                        deleniti
                                        adipisci culpa? Quos sit dolore magnam minima, optio nobis commodi!</p>
                                </div>
                                <div class="cs_tab" data-id="moments">
                                    <p class="m-0">Lorem ipsum dolor sit amet, <span
                                            class="cs_accent_color">consectetuer
                                            adipiscing elit</span>. Cum sociis natoque penatibus et magnis dis parturient
                                        montes,<span class="cs_accent_color"> nascetur ridiculus</span> mus. Donec quam
                                        felis,
                                        ultricies nec, <span class="cs_accent_color_2">pellentesque eu</span>, pretium
                                        quis,
                    ...
                    <div class="col-lg-8">
                        <div class="cs_pl_70 cs_tab active" data-id="travel">
                            <div class="cs_gallery_grid">
                                <div class="cs_gallery cs_style_1">
                                    <img class="w-100" src="/front/assets/img/gallery/gallery_1.jpg" alt="">
                                </div>
                                <div class="cs_gallery cs_style_1">
                                    <img class="w-100" src="/front/assets/img/gallery/gallery_3.jpg" alt="">
                                </div>
                                <div class="cs_gallery cs_style_1">
                                    <img class="w-100" src="/front/assets/img/gallery/gallery_2.jpg" alt="">
                                </div>
                                <div class="cs_gallery cs_style_1">
                                    <img class="w-100" src="/front/assets/img/gallery/gallery_4.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="cs_pl_70 cs_tab" data-id="creativity">
                            <div class="cs_gallery_grid">
                                <div class="cs_gallery cs_style_1">
                                    <img class="w-100" src="/front/assets/img/gallery/gallery_5.jpeg" alt="">
                                </div>
                                <div class="cs_gallery cs_style_1">
                                    <img class="w-100" src="/front/assets/img/gallery/gallery_6.jpeg" alt="">
                                </div>
                                <div class="cs_gallery cs_style_1">
                                    <img class="w-100" src="/front/assets/img/gallery/gallery_7.jpeg" alt="">
                                </div>
                                <div class="cs_gallery cs_style_1">
                                    <img class="w-100" src="/front/assets/img/gallery/gallery_8.jpeg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="cs_pl_70 cs_tab" data-id="moments">
                            <div class="cs_gallery_grid">
                                <div class="cs_gallery cs_style_1">
                                    <img class="w-100" src="/front/assets/img/gallery/gallery_9.jpeg" alt="">
                                </div>
                                <div class="cs_gallery cs_style_1">
                                    <img class="w-100" src="/front/assets/img/gallery/gallery_10.jpeg" alt="">
                                </div>
                                <div class="cs_gallery cs_style_1">
                                    <img class="w-100" src="/front/assets/img/gallery/gallery_11.jpeg" alt="">
                                </div>
                                <div class="cs_gallery cs_style_1">
                                    <img class="w-100" src="/front/assets/img/gallery/gallery_12.jpeg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
