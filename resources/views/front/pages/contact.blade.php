                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form method="POST" action="{{ route('send_email') }}">
                            ...
                            <input value="{{ old('subject') }}" class="form-control" type="subject" name="subject"
                            ...
                            <textarea class="form-control" name="message" placeholder="Your message" cols="30" rows="5"> {{ old('message') }} </textarea>
                            @error('message')
                                <span class="text-danger"> {{ $message }} </span>
                            @enderror
                            <div class="cs_height_25 cs_height_lg_25"></div>

                            <button type="submit" class="cs_btn cs_style_1 cs_primary_font"><span>Send
                                    Message</span></button>
                        </form>
