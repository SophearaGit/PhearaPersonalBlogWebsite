...
@section('content')
    ...
    <div class="pd-20 card-box mb-30">
        <form action="{{ route('admin.update_portfolio', ['portfolio_id' => $portfolio->id]) }}" method="POST"
            autocomplete="off" enctype="multipart/form-data" id="updatePortfolioForm">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <textarea class="form-control" name="overview" placeholder="Enter overview here">{!! $portfolio->overview !!}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10" style="max-width: 250px">
                    <img src="" alt="" class="img-thumbnail" id="featured_image_preview"
                        data-ijabo-default-img="/images/portfolios/resized/resized_{{ $portfolio->featured_image }}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <textarea name="content" id="content" cols="30" rows="10" class="ckeditor form-control"
                        placeholder="Enter project content...">{!! $portfolio->content !!}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <textarea name="project_challenge" id="project_challenge" cols="30" rows="10" class="ckeditor form-control"
                        placeholder="Describe the project challenge...">{!! $portfolio->project_challenge !!}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <textarea name="design_research" id="design_research" cols="30" rows="10" class="ckeditor form-control"
                        placeholder="Enter design research details...">{!! $portfolio->design_research !!}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <textarea name="design_approach" id="design_approach" cols="30" rows="10" class="ckeditor form-control"
                        placeholder="Describe the design approach...">{!! $portfolio->design_approach !!}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <textarea name="the_solution" id="the_solution" cols="30" rows="10" class="ckeditor form-control"
                        placeholder="Explain the solution provided...">{!! $portfolio->the_solution !!}</textarea>
