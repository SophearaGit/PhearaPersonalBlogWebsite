...
<body class="header-dark">
    ...
    <div class="right-sidebar">
        ...
        <div class="right-sidebar-body customscroll">
            <div class="right-sidebar-body-content">
                ...
                <div class="sidebar-btn-group pb-30 mb-10">
                    <a href="javascript:void(0);" class="btn btn-outline-primary sidebar-dark">White</a>
    ...
    <div class="left-side-bar">
        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu icon-style-2 icon-list-style-6">
                <ul id="accordion-menu">
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="{{ route('admin.add_post') }}"
                                    class="{{ Route::is('admin.add_post') ? 'active' : '' }}">New</a>
                            </li>
                            <li>
                        ...
                        <li
                            ...
                            <ul class="submenu">
                                <li><a href="{{ route('admin.add_portfolio') }}"
                                        class="{{ Route::is('admin.add_portfolio') ? 'active' : '' }}">New</a></li>
                                <li><a href="{{ route('admin.portfolios') }}"
                                        class="{{ Route::is('admin.portfolios') ? 'active' : '' }}">Portfolios</a>
                                </li>
                            </ul>
                        </li>
                    @endif
                    ...
                    @if (auth()->user()->type == 'super_admin')
                        <li>
                            <a href="{{ route('admin.Settings') }}" target=""
